        ...
        for bug in bugs:
            ...
            if d and p and wp > 0:
                ...
                for tk in tks:
                    ...
                    # Each value in k_map is a tuple of the form (c,v) where
                    # c is the frequency of each noun and v is the cumulative
                    # priority

                    if tk in k_map:
                        c = k_map[tk]
                        count = c[0] + 1
                        k_map[tk] = (count, c[1] + wp)
                    else:
                        k_map[tk] = (1, wp)
        ...
        for bug in bugs:
            ...
            if d and p and wp > 0:
                ...
                for tk in tks:
                    ...
                    if tk in k_map:
                        c = k_map[tk]
                        cp = cp + math.ceil(c[1] / c[0])
                        found = found + 1

                if found > 0:
                    cpp = int(math.ceil(cp/found))
